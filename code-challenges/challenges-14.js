...
const replaceWords = (str) => {
  let reName = str.split(" ");
  reName.splice(reName.indexOf("I"), 1, "We");
  reName.splice(reName.indexOf("am"), 1, "are");
  reName.splice(reName.indexOf("was"), 1, "were");
  let rRplace = str.split(" ");
  
  reName.splice(reName.length - 1, 1, rRplace[rRplace.length - 1]);
  let rRplace2 = reName.join(" ");
